...
window.onload = function () {
  ...
  const cnrDataSchema = {
    ...
    cnrDirections:
      'Directions to find this hike place.'
  };

  const cnrHikesVar = new cnrItems.cnrItemsClass('cnrHikes', 'schema', cnrDataSchema);
  ...
  const cnrErrorsVar = cnrHikesVar.cnrGetLastErrorMessage();
  if (cnrErrorsVar != '') {
    console.log(cnrErrorsVar.cnrGetLastErrorMessage());
  };

  // display items
  cnrDisplay.cnrRenderItems('cnrjscontainerdiv1', cnrHikesVar.cnrGetAllItemsDataForName('hike'));
